...
var (
	...
	ErrMissingGitLabEventHeader = errors.New(
		"missing X-Gitlab-Event Header",
	)
	ErrGitLabTokenVerificationFailed = errors.New(
		"X-Gitlab-Token validation failed",
	)
	ErrEventNotFound = errors.New(
		"event not defined to be parsed",
	)
	ErrParsingPayload       = errors.New("error parsing payload")
	ErrParsingSystemPayload = errors.New(
		"error parsing system payload",
	)
